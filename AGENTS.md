...
2. **Layout directives (remark):** use a **flex** container with optional `align-items`, `justify-content`, `flex-direction`, and `gap` (unitless numbers, including negatives, are treated as `rem`):
